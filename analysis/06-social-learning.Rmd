...
```{r shared-data-by-quantile-long-term, fig.height=6, fig.width=7}
df_data_means %>% 
  display_quantity(mean_datasets)
```

```{r shared-data-by-quantile-myopic, fig.height=6, fig.width=7}
df_data_means %>% 
...
```{r sharers-by-quantile-long-term, fig.height=6, fig.width=7}
df_data_sharers %>% 
  display_quantity(share_of_sharers)
```

```{r sharers-by-quantile-myopic, fig.height=6, fig.width=7}
df_data_sharers %>% 
