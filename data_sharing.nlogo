...
<experiments>
  ...
  <experiment name="sharing-funders" repetitions="20" sequentialRunOrder="false" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <metric>mean-grants groups</metric>
    <metric>mean-publications groups</metric>
  ...
  <experiment name="sharing-funders-2" repetitions="30" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <metric>mean-grants groups</metric>
    <metric>mean-publications groups</metric>
